...
describe('PostgresProductRepository', () => {
  ...
  describe('create', () => {
    it('should create a new product', async () => {
      ...
      expect(mockProductRepository.save).toHaveBeenCalledWith(mockPostgresProduct);
  ...
  describe('countByModelName', () => {
    it('should return count of products by model name', async () => {
      ...
      expect(mockProductRepository.count).toHaveBeenCalledWith({ where: { modelName: 'Test Model' } });
  ...
  describe('countByName', () => {
    it('should return count of products by name', async () => {
      ...
      expect(mockProductRepository.count).toHaveBeenCalledWith({ where: { name: 'Test Product' } });
  ...
  describe('findByModelName', () => {
    it('should find products by model name', async () => {
      ...
      expect(mockProductRepository.find).toHaveBeenCalledWith({ where: { modelName: 'Test Model' } });
  ...
  describe('findByName', () => {
    it('should find products by name', async () => {
      ...
      expect(mockProductRepository.find).toHaveBeenCalledWith({ where: { name: 'Test Product' } });
      expect(result).toEqual(mockProducts);
    });
  });
});
