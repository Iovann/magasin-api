...
export class ProductsController {
  ...
  @ApiOperation({
    summary: "Crée un nouveau modèle de pistolet (SuperAdmin, Magasinier)",
  })
  @ApiResponse({
    status: 201,
    description: "Le pistolet a été créé avec succès.",
  })
  ...
  @ApiOperation({
    summary: "Récupère le nombre total de tous les pistolets à eau",
  })
  @ApiResponse({
    status: 200,
    description: "Nombre total de pistolets à eau retourné.",
  })
  getTotalStock() {
  ...
  @ApiOperation({
    summary: "Supprime un modèle de pistolet par son ID (SuperAdmin)",
  })
  @ApiResponse({
    status: 204,
    description: "Le modèle de pistolet a été supprimé avec succès.",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Détails du modèle de pistolet retournés.",
  })
  @ApiResponse({ status: 404, description: "Modèle de pistolet non trouvé." })
  ...
  @ApiResponse({
    status: 200,
    description: "Liste des pistolets à eau retournée.",
  })
  getAllProducts() {
  ...
  @ApiOperation({
    summary:
      "Met à jour la quantité de stock d'un modèle de pistolet (SuperAdmin, Magasinier)",
  })
  @ApiResponse({
    status: 200,
  ...
  @Roles(Role.Vendeur)
  @ApiOperation({
    summary: "Vend une quantité de modèle de pistolet (Vendeur)",
  })
  @ApiResponse({
    status: 200,
    description: "Modèle de pistolet vendu avec succès.",
  })
  @ApiResponse({
    status: 400,
    description: "Quantité insuffisante en stock ou données invalides.",
  })
  @ApiResponse({ status: 404, description: "Modèle de pistolet non trouvé." })
  ...
  @Roles(Role.SuperAdmin, Role.Magasinier, Role.Vendeur)
  @ApiOperation({
    summary: "Récupère tous les pistolets à eau par nom de modèle",
  })
  @ApiResponse({
    status: 200,
    description: "Liste des pistolets à eau par modèle retournée.",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Liste des pistolets à eau par nom retournée.",
  })
  ...
  @Roles(Role.SuperAdmin, Role.Magasinier, Role.Vendeur)
  @ApiOperation({
    summary: "Compte le nombre de pistolets à eau par nom de modèle",
  })
  @ApiResponse({
    status: 200,
    description: "Nombre de pistolets à eau par modèle retourné.",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Nombre de pistolets à eau par nom retourné.",
  })
