...
describe('FsUserRepository', () => {
  ...
  beforeEach(async () => {
    ...
    (mockFs.promises.readFile as jest.Mock).mockResolvedValue(JSON.stringify([mockUser]));
  ...
  describe('constructor', () => {
    it('should create directory if it does not exist', async () => {
      ...
      const newRepository = new FsUserRepository({ dbPath: testDataPath } as any);
      await newRepository.onModuleInit();
      
      expect(mockFs.promises.mkdir).toHaveBeenCalledWith(testDataPath, { recursive: true });
    });
  ...
  describe('update', () => {
    ...
    it('should update multiple fields', async () => {
      ...
      expect(result).toEqual({ ...mockUser, isBlocked: true, role: Role.Magasinier });
    });
  ...
  describe('error handling', () => {
    ...
    it('should handle file write errors', async () => {
      ...
      (mockFs.promises.writeFile as jest.Mock).mockRejectedValue(new Error('File write error'));
      
      await expect(repository.create(createUserData)).rejects.toThrow('File write error');
    });
    ...
    it('should handle directory creation errors', async () => {
      ...
      (mockFs.promises.mkdir as jest.Mock).mockRejectedValue(new Error('Directory creation error'));
      
      await expect(errorRepository.onModuleInit()).rejects.toThrow('Directory creation error');
    });
  });
  ...
  describe('file operations', () => {
    it('should use correct file path', () => {
      ...
      expect(mockPath.resolve).toHaveBeenCalledWith('/custom/data/path', 'users.json');
    });
