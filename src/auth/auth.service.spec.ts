...
describe('AuthService', () => {
  ...
  describe('login', () => {
    it('should return access and refresh tokens', async () => {
      ...
      expect(usersService.setCurrentRefreshToken).toHaveBeenCalledWith('refreshToken', mockUser.id);
  ...
  describe('getTokens', () => {
    it('should return access and refresh tokens', async () => {
      jwtService.signAsync.mockResolvedValueOnce('accessToken').mockResolvedValueOnce('refreshToken');
      const result = await authService.getTokens(mockUser.id, mockUser.email, mockUser.role);
